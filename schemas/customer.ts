...
export const CustomerSchema = z.object({
  name: z
    ...
    .max(200)
    .trim()
    .describe("Nombre completo o razón social."),
  ...
  phone: z
    ...
    .trim()
    .optional()
    .describe("Teléfono en formato libre o E.164 según integración."),
  company: z
    .string()
    .max(200)
    .trim()
    .optional()
    .describe("Empresa u organización."),
  notes: z
    .string()
    .max(2000)
    .trim()
    .default("")
    .describe("Notas internas o del CRM."),
});
