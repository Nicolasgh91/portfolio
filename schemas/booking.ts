...
export const BookingSchema = z.object({
  customer_id: z
    ...
    .uuid()
    .optional()
    .describe("Cliente existente en el sistema, si aplica."),
  customer_name: z
    .string()
    .min(1)
    .max(200)
    .trim()
    .describe("Nombre quien reserva (obligatorio)."),
  customer_email: z
    .string()
    .email()
    .max(320)
    .optional()
    .describe("Email para confirmación."),
  customer_phone: z
    .string()
    .max(30)
    .trim()
  ...
  service: z
    ...
    .max(200)
    .trim()
    .describe("Servicio o recurso reservado (texto libre o slug)."),
  ...
  notes: z
    ...
    .trim()
    .default("")
    .describe("Comentarios del cliente o del agenda."),
  status: z
