...
export const EventSchema = z.object({
  type: z
    ...
    .min(1)
    .max(100)
    .describe("Tipo de evento de dominio (p. ej. order.created)."),
  entity_type: z
    .string()
    .min(1)
    .max(50)
    .describe("Nombre de la entidad afectada (tabla o agregado)."),
  ...
  actor_id: z
    ...
    .uuid()
    .optional()
    .describe("Usuario o sistema que originó el evento."),
  timestamp: z
    .string()
    .datetime()
    .optional()
