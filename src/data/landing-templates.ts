...
const rawLandingTemplates = [
  {
    ...
    featuresEn: ["Category catalog", "WhatsApp CTA", "Local SEO"],
  ...
  },
  {
    ...
    featuresEn: ["Responsive grid", "Stock badges", "Warm branding"],
    cardBackground: "warm",
    priceGroup: "basico" as const,
    priceLabel: "Desde ARS 20.000",
    priority: 0.85,
  ...
  },
  {
    ...
    featuresEn: ["Clear hero", "Cases and testimonials", "Contact form"],
  ...
  },
  {
    ...
    featuresEn: ["Modular blocks", "Newsletter", "Linked social profiles"],
    cardBackground: "dark",
  ...
  },
  {
    ...
    featuresEn: ["Categories", "Product detail page", "Catalog SEO"],
    cardBackground: "light",
    demoUrl: "/productos",
    priceGroup: "plantilla" as const,
    priceLabel: "Desde ARS 35.000",
  ...
  },
  {
    ...
    featuresEn: ["Listings", "Gallery", "Lead capture"],
    cardBackground: "warm",
  ...
  },
  {
    ...
    featuresEn: ["Service sections", "Trust and credentials", "Contact"],
    cardBackground: "dark",
    priceGroup: "basico" as const,
  ...
  },
  {
    ...
    featuresEn: ["Clear sections", "Social proof", "Contact CTA"],
    cardBackground: "light",
    priceGroup: "basico" as const,
    priceLabel: "Desde ARS 20.000",
    priority: 0.92,
