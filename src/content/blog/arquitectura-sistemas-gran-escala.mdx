...
references:
  - title: "Designing Data-Intensive Applications"
    url: "https://www.dataintensive.net/"
...
¿Cuántas veces escuchaste que un sistema "se cayó por el tráfico"? Detrás de esa frase hay una decisión de arquitectura que se tomó mal, o directamente no se tomó. Este artículo parte del libro de referencia de la industria —_Designing data-intensive applications_, de Martin Kleppmann— y lo traduce a decisiones concretas que cualquier negocio en crecimiento necesita entender.
...
Cada servidor tiene su propio reloj físico que tiende a adelantarse o atrasarse con el tiempo. En un sistema distribuido que usa timestamps para resolver conflictos del tipo "gana el último que escribió" (_last write wins_), un servidor con la hora mal configurada puede sobreescribir datos más nuevos con datos más viejos.
