...
**2026-03-24.** Solo importaciones entre **layouts**, **páginas** y **componentes** bajo `src/`. Flecha: _A importa B_.
...
`HeroSection`, `Nav`, `ServiceCard`, `BlogCard`, `TaxonomyFilter`, `ContactForm`, `FaqSection`, `CapabilityCard`, `SlideViewer`, `SectionSpacer`, `ArticleFooter`, `ShareBar`, `TableOfContents`, `TableWrapper`, `ProjectDemo` _(no usado en páginas)_.
