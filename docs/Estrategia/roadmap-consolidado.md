...
*Documento único de referencia. Reemplaza a: `Roadmap.md`, `roadmap-accion-escalatunegocio.md`, `integracion-nuevas-ideas-roadmap.md`, `tareas-por-fase-escalatunegocio.md`.*
