...
| `revealAlt`     | `boolean`                         | No        | Si es `true`, añade `data-alt-reveal` y clases iniciales de Alt B (`opacity-0`, `translate-y-4`, transición). El observer se activa por presencia de nodos `data-alt-reveal`, no por whitelist de rutas (ver [`scroll-reveal.md`](../scroll-reveal.md)).                                             |
