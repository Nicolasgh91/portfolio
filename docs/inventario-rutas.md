...
| `/blog`                        |     1 | `blog/index.astro`                  | Estática               | Listado de posts publicados sobre sistemas, arquitectura e IA explicados para negocios; traduce decisiones técnicas a eficiencia, rentabilidad e impacto operativo. Filtro por categorías y etiquetas (`TaxonomyFilter`). | `blog`               | `BlogCard`, `TaxonomyFilter`; `getCollection('blog')`                                                                 | tokens + **scoped** | Indexable                                                                              |
