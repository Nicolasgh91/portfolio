...
- **Animaciones Semánticas:** \* _Contenido inmersivo (Blog):_ Animaciones profundas (`hover:-translate-y-2 hover:shadow-2xl`).
  - _Conversión (Servicios B2B):_ Animaciones sutiles y premium (`hover:-translate-y-1 hover:shadow-orange-500/10`).
  - _Escaneo técnico (Píldoras/Skills):_ Interacciones táctiles estables (`hover:scale-[1.02] hover:bg-orange-500/10`).
