...
1. [Los tres pilares de todo sistema intensivo en datos](#1-los-tres-pilares-de-todo-sistema-intensivo-en-datos)
2. [Modelos de datos: cuándo usar SQL y cuándo no](#2-modelos-de-datos-cuándo-usar-sql-y-cuándo-no)
3. [Replicación: consistencia vs. disponibilidad](#3-replicación-consistencia-vs-disponibilidad)
4. [Procesamiento: batch vs. stream](#4-procesamiento-batch-vs-stream)
5. [Comparativa de tecnologías por caso de uso](#5-comparativa-de-tecnologías-por-caso-de-uso)
