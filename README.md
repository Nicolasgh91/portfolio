...
Este repositorio implementa flujos de trabajo profesionales para garantizar la estabilidad del código:

- **Integración continua (CI):** Validaciones automáticas en cada Pull Request mediante GitHub Actions.
- **Branch protection:** Reglas estrictas en la rama main (requiere PR y commits firmados).
- **Pre-commit hooks:** Implementación de Husky y Lint-staged para asegurar que todo el código subido cumpla con el formato de Prettier.
- **Conventional commits:** Historial de cambios estandarizado para facilitar el mantenimiento.
